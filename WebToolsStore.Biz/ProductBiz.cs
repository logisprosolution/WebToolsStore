...
{
    public class ProductBiz : BaseDB<ProductModel>
    {
        #region Biz Methods
        public ProductBiz() : base()
        {
        ...
        public DataTable SelectIngredient(int id)
        {
        ...
        protected override void DoSelectById(int id, ref DataSet ds, string condition)
        {
            ...
            else if (condition == "SelectIngredient")
            {
            ...
            if (condition == SAVE_INFO)
            {
                if (model != null)
                {
                    ...
                    foreach (MAS_Ingredient detail in model.MasIngredientList)
                    {
                        ...
                        cmd2.Parameters.Add(CreateParameter("ingredient_product", detail.ingredient_product));
