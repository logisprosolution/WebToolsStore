<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="SupplierInfo.aspx.cs" Inherits="WebToolsStore.SupplierInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">บริษัทคู่ค้า</li>
    </ol>
</asp:Content>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12" style="display:none">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_code" runat="server" type="text" class="form-control" />
                    </div>
                    <div class="col-sm-3"></div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_name" runat="server" type="text" class="form-control" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_supplier_name" Display="Dynamic" ErrorMessage="กรุณากรอกข้อมูล" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_tel1" runat="server" type="text" class="form-control" />
                        <asp:RegularExpressionValidator ValidationExpression="^[0][2|8|9][0-9]([0-9]{3})([0-9]{3,4}$)" runat="server" ControlToValidate="txt_supplier_tel1" Display="Dynamic" ErrorMessage="เบอร์โทรศัพท์ไม่ถูกต้อง (08|09xxxxxxxx)" ForeColor="#CC3300"></asp:RegularExpressionValidator>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_supplier_tel1" Display="Dynamic" ErrorMessage="กรุณากรอกข้อมูล" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_tel2" runat="server" type="text" class="form-control" />
                        <asp:RegularExpressionValidator ValidationExpression="^[0][2|8|9][0-9]([0-9]{3})([0-9]{3,4}$)" runat="server" ControlToValidate="txt_supplier_tel2" Display="Dynamic" ErrorMessage="เบอร์โทรศัพท์ไม่ถูกต้อง (08|09xxxxxxxx)" ForeColor="#CC3300"></asp:RegularExpressionValidator>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_email" runat="server" type="text" class="form-control" />
                        <asp:RegularExpressionValidator ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" runat="server" ControlToValidate="txt_supplier_email" Display="Dynamic" ErrorMessage="E-mail ไม่ถูกต้อง" ForeColor="#CC3300"></asp:RegularExpressionValidator>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txt_supplier_address" runat="server" type="text" class="form-control" TextMode="MultiLine" MaxLength="300" ToolTip="ความยาวไม่เกิน 300 ตัวอักษร" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_supplier_address" Display="Dynamic" ErrorMessage="กรุณากรอกข้อมูล" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
            </div>
