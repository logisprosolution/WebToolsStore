<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="UnitList.aspx.cs" Inherits="WebToolsStore.UnitList" %>
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    ...
                                    <Columns>
                                     ...
                                     <%--   <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="unit_code" HeaderText="รหัสสินค้า">
                                        ...
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="unit_value" HeaderText="จำนวนหน่วย">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdfID" runat="server" Value='<%# Eval("unit_id") %>' />
