<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="ReceiveproductInfo(Original).aspx.cs" Inherits="WebToolsStore.ReceiveproductInfo" %>
    ...
    <div class="box box-primary">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">รหัสบิล</label>
                    </div>
                    <div class="col-sm-4">
                        <div class="input-group margin" style="margin: 0px;">
                            ...
                            <div class="input-group-btn">
                                <asp:LinkButton runat="server" ID="LinkButton3" ToolTip="นำเข้าจาก" class="btn btn-info btn-flat"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label">วันที่รับเข้า <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">บริษัทคู่ค้า <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-2">
                        <label class="control-label">การชำระเงิน <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
                        <asp:TextBox ID="TextBox3" runat="server" type="text" class="form-control" MaxLength="30" ToolTip="ความยาวไม่เกิน 30 ตัวอักษร" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_header_name" Display="Dynamic" ErrorMessage="กรุณากรอกข้อมูล" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">วันที่ชำระงเิน <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
                        <div class="input-group date" data-provide="datepicker" data-date-language="th">
                            <asp:TextBox ID="TextBox5" runat="server" type="text" class="form-control" />
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-header">
                    ...
                    <asp:LinkButton runat="server" CausesValidation="False" ID="btnAdd" class="btn btn-primary pull-right" OnClientClick="javascript:ShowDialog(); return false;"> เพิ่ม <i class="fa fa-plus" aria-hidden="true"></i></asp:LinkButton>
