<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="WebToolsStore.CustomerList" %>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="customer_code" HeaderText="รหัสลูกค้า">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>--%>
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="customer_name" HeaderText="ชื่อบริษัท/ชื่อลูกค้า">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdfID" runat="server" Value='<%# Eval("customer_id") %>' />
