<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="EmployeeList.aspx.cs" Inherits="WebToolsStore.EmployeeList" %>
...
<%--                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="lastname" HeaderText="นามสกุล">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>--%>
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="user_namedis" HeaderText="ชื่อที่แสดง">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
