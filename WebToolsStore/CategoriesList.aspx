<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="CategoriesList.aspx.cs" Inherits="WebToolsStore.CategoriesList" %>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="categories_code" HeaderText="รหัส">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="categories_name" HeaderText="ชื่อหมวด">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdfID" runat="server" Value='<%# Eval("categories_id") %>' />
