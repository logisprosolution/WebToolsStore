...
namespace WebToolsStore
{
    public partial class CategoriesList : BasePage
    {
        ...
        {
            roleMenu = ApplicationWebInfo.RoleMenuList.Find(x => x.submenu_id == (int)Enumerator.SubMenu.Categories);
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                base.SetBackURL();
                base.RedirectToPage(typeof(CategoriesInfo), null);
            }
            catch (Exception ex)
            {
                base.HandleException(ex);
        ...
        protected void dgv1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    base.SetBackURL();
                    base.RedirectToPage(typeof(CategoriesInfo), id);
                }
