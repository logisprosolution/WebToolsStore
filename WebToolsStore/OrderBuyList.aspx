<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="OrderBuyList.aspx.cs" Inherits="WebToolsStore.OrderBuyList" %>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="header_supplier_name" HeaderText="บริษัทคู่ค้า">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="user_name" HeaderText="ผู้ทำรายการ">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="วันที่สั่งซื้อ" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
