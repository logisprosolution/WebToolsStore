...
namespace WebToolsStore
{
    public partial class SupplierList : BasePage
    {
        ...
        {
            roleMenu = ApplicationWebInfo.RoleMenuList.Find(x => x.submenu_id == (int)Enumerator.SubMenu.Supplier);
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                base.SetBackURL();
                base.RedirectToPage(typeof(SupplierInfo), null);
            }
            catch (Exception ex)
            {
                base.HandleException(ex);
        ...
        protected void dgv1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    base.SetBackURL();
                    base.RedirectToPage(typeof(SupplierInfo), id);
                }
