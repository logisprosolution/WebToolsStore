<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="ChangeInfo(Original).aspx.cs" Inherits="WebToolsStore.ChangeInfo" %>
    ...
    <div class="box box-primary">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">เลขที่เปลี่ยน</label>
                    </div>
                    <div class="col-sm-4">
                        <asp:TextBox ID="TextBox1" runat="server" type="text" class="form-control" />
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label">รหัสบิล <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">ลูกค้า <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-2">
                        <label class="control-label">วันที่เปลี่ยน <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">วันที่จัดส่ง <label style="color: red">*</label></label>
                    </div>
                    <div class="col-sm-4">
                        <div class="input-group date" data-provide="datepicker" data-date-language="th">
                            <asp:TextBox ID="txt_header_sent" runat="server" type="text" class="form-control" />
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_header_sent" Display="Dynamic" ErrorMessage="กรุณาเลือกวันที่" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-2">
