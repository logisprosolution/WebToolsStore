<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="ExportList.aspx.cs" Inherits="WebToolsStore.ExportList" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-header">
                            <h3 class="box-title">รายการนำออก</h3>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="วันที่นำออก" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
