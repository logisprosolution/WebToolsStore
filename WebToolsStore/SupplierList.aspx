<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" CodeBehind="SupplierList.aspx.cs" Inherits="WebToolsStore.SupplierList" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-header">
                            <h3 class="box-title">รายการลูกค้า</h3>
                        ...
                        <div class="box-body">
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <asp:GridView ID="dgv1" class="table table-bordered table-hover dataTable" aria-describedby="example2_info" runat="server"
                                    AutoGenerateColumns="false" AllowSorting="True" PageSize="50" DataKeyNames="supplier_id"
                                 ...
                                 <%--       <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="supplier_code" HeaderText="รหัสบริษัทคู่ค้า">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>--%>
                                        <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="supplier_name" HeaderText="ชื่อบริษัทคู่ค้า">
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdfID" runat="server" Value='<%# Eval("supplier_id") %>' />
