...
namespace WebToolsStore
{
    public partial class ExportList : BasePage
    {
        ...
        {
            biz.dataModel.SubDoctype_id = ConvertHelper.ToInt(ConfigurationManager.AppSettings["SubDocTypeID_OT"].ToString());
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                base.SetBackURL();
                base.RedirectToPage(typeof(ExportInfo), null);
            }
            catch (Exception ex)
            {
                base.HandleException(ex);
        ...
        protected void dgv1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    base.SetBackURL();
                    base.RedirectToPage(typeof(ExportInfo), id);
                }
